...
export default function Library() {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="xl:grid-cols-4 lg:grid-cols-3 grid md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-2 mt-16 justify-evenly md:gap-y-10 md:gap-x-8 sm:gap-y-8 sm:gap-x-6 xxs:gap-x-4 xxs:gap-y-4 lg:mx-4 md:mx-0 sm:mx-0 xs:mx-0 xxs:mx-0" 
        layout>

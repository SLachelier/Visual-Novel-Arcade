...
export default function VNMakerContent() {
      ...
      >
        <form className='flex items-center justify-center gap-4 mb-6' onSubmit={handleSubmit}>
          <input 
            ...
            className='flex-1 max-w-md h-12 p-4 border border-gray-300 rounded-md bg-slate-500 focus:border-gray-100 outline-none text-white placeholder-gray-300' 
            placeholder='My Visual Novel' 
            required
          />
          <button 
            type='submit' 
            className='h-12 px-6 bg-yellow-600 text-white text-2xl rounded-md hover:bg-yellow-500 transition-colors duration-300 whitespace-nowrap'
          >
            Save Name
          </button>
        </form>

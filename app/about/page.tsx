...
export default function About() {
  return(
    <section className='flex flex-col items-center px-4 min-h-fit'>
      <h1 className='lg:text-8xl text-center mt-10 sm:text-6xl xs:text-4xl xxs:text-4xl py-[2rem] text-gradient stroke-gold-shine'>About</h1>
      <span className='border-2 border-amber-400/70 rounded-xl w-3/5 px-10 py-8 mt-10 mb-6'> 
